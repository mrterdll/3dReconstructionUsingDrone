...
class OrbitNavigator:
    ...
    def __init__(self,client = airsim.MultirotorClient(), radius = 2, altitude = 10, speed = 2, iterations = 1, center = [1,0], snapshots = None):
        #kendi clientini olusturan constructor
        self.radius = radius
    ...
    def do_initial_calculations(self):
    ...
    def __del__(self):
        #Classin isi bittigi icin api controlu saliyoruz
        #self.client.armDisarm(False)
        if(self.libMode == False):
            self.client.enableApiControl(False)
        pass

    def start(self):
        self.libMode = False
        self.do_initial_calculations()
